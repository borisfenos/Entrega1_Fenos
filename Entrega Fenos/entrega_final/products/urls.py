...
from products.views import List_products, List_graficas, List_procesadores, Create_product, search_products, Detail_product, Delete_product, Update_product

urlpatterns =[
    path('', List_products.as_view(), name = 'list_products'),
    path('', List_graficas.as_view(), name = 'list_graficas'),
    path('', List_procesadores.as_view(), name = 'list_procesadores'),
